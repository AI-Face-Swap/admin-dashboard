...
class HomeShowcaseController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        if ($request->hasFile('video_url')) {
            ...
            $path = $file->storeAs('HomeShowcase', \Illuminate\Support\Str::uuid().'.'.$file->getClientOriginalExtension(), 'spaces');
        ...
        if ($request->hasFile('image_fallback_url')) {
            ...
            $path = $file->storeAs('HomeShowcase', \Illuminate\Support\Str::uuid().'.'.$file->getClientOriginalExtension(), 'spaces');
            $data['image_fallback_url'] = \Illuminate\Support\Facades\Storage::disk('spaces')->url($path);
        }
