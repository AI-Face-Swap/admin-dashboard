...
### API playground logs (Phase 7)

| Table | Purpose |
|---|---|
| `api_request_logs` | Every request made from the admin API playground: method, path, headers, body, response, duration |
