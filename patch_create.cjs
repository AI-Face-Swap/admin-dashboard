const fs = require('fs');
const file = 'resources/js/pages/admin/templates/create.tsx';
let code = fs.readFileSync(file, 'utf8');

// Add state variables
code = code.replace(/const \[description, setDescription\] = useState\(''\);/, `const [description, setDescription] = useState('');
